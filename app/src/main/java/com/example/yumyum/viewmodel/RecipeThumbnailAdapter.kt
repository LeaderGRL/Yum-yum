    ...
    class recipeItemViewHolder(val view: View) : RecyclerView.ViewHolder(view){
        ...
        init {
            imageView.setOnClickListener(View.OnClickListener() {
                println("Start RecipeDetailsActivity")
                println(absoluteAdapterPosition)
                val intent = Intent(imageView.context, RecipeDetailsActivity::class.java)
                intent.putExtra("position", absoluteAdapterPosition.toString())
